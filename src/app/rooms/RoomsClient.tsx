        ...
        <div className="bg-neutral-50 border border-neutral-100 p-5 mb-12">
          ...
          <div className="space-y-1.5 text-sm text-neutral-700">
            <div className="flex justify-between">
              <span className="text-neutral-500">수영장 이용 (온수풀)</span>
              <span>+ 100,000원</span>
            </div>
            <div className="flex justify-between">
...
function RoomB() {
  return (
    <div>
      <ScrollGallery
        items={["/photos/b/main.jpg", "/photos/b/1.jpg", "/photos/b/2.jpg", "/photos/b/2-2.jpg", "/photos/b/3.jpg", "/photos/b/living-bw.jpg", "/photos/b/5.jpg", "/photos/b/bedroom-twin.jpg", "/photos/b/8.jpg", "/photos/b/9.jpg", "/photos/b/ondol.jpg", "/photos/b/bath.jpg"]}
        itemWidth={440}
        itemHeight={668}
        gap={8}
        sidePadding={0}
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-0 mt-8">
        ...
        <h3 style={{ fontSize: 18, fontWeight: 600 }} className="text-black mb-4">객실 공간</h3>
        <div className="flex flex-wrap gap-3 mb-12">
          {["침실(2)", "온돌방(1)", "화장실(3)", "거실(1)", "주방(1)", "욕조(1)", "드레스룸(1)", "테라스(1)"].map((item) => (
            <span key={item} className="px-4 py-2 bg-neutral-100 text-sm text-neutral-700 rounded">{item}</span>
          ))}
        </div>
